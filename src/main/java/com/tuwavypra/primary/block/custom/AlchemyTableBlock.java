package com.tuwavypra.primary.block.custom;

import com.tuwavypra.primary.block.entity.AlchemyTableBlockEntity;
...
//    BLOCK ENTITY
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.ALCHEMY_TABLE, AlchemyTableBlockEntity::tick);
    }
}
